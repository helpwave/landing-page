...
const defaultStoriesSliderSectionTranslation: Translation<StoriesSliderSectionTranslation> = {
  en: {
    step: 'Step',
...
export const StoriesSliderSection = () => {
  ...
  return (
    <SectionBase className="col gap-y-8 w-full !max-w-[1600px]" outerClassName="!px-0">
      <Carousel hintNext={true} isLooping={true} isAutoPlaying={true} className="tablet:h-[300px]">
