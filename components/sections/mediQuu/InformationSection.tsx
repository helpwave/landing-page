...
import { MarkdownInterpreter, useTranslation } from '@helpwave/hightide'
...
const defaultMediQuuInformationTranslation: Translation<MediQuuInformationTranslation> = {
  en: {
    ...
    subTitle3: 'We would be delighted to meet you in person, simply send your suggested dates to',
  },
  de: {
    ...
    subTitle3: 'Wir würden uns über ein persönliches Kennenlernen sehr freuen, senden Sie Ihre Terminvorschläge ganz einfach an'
  }
}
